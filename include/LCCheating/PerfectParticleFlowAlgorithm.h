...
private:
   ...
   */
  void SimpleCaloHitCollection(const pandora::MCParticle* const pPfoTarget, const pandora::CaloHit* const pCaloHit,
   ...
   */
  void FullCaloHitCollection(const pandora::MCParticle* const pPfoTarget, const pandora::CaloHit* const pCaloHit,
                             pandora::CaloHitList& caloHitList) const;
   ...
   *  @param  pfoParameters the pfo parameters
   */
  void SetPfoParametersFromTracks(const pandora::MCParticle* const pPfoTarget, int& nTracksUsed,
   ...
   *  @param  pfoParameters the pfo parameters
   */
  void SetPfoParametersFromClusters(const pandora::MCParticle* const pPfoTarget, const int nTracksUsed,
                                    PfoParameters& pfoParameters) const;
   ...
   */
  const pandora::CartesianVector GetEnergyWeightedCentroid(const pandora::Cluster* const pCluster,
   ...
   *  @param  pfoParameters the pfo parameters
   */
  void PfoParameterDebugInformation(const pandora::MCParticle* const pPfoTarget, const int nTracksUsed,
                                    PfoParameters& pfoParameters) const;
